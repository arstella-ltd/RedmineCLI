...
public class TableFormatter : ITableFormatter
{
    ...
    public void FormatIssues(List<Issue> issues)
    {
        ...
        foreach (var issue in issues)
        {
            table.AddRow(
                ...
                issue.DueDate.HasValue ? _timeHelper.FormatTime(issue.DueDate.Value, _timeFormat) : "-",
    ...
    public void FormatIssueDetails(Issue issue)
    {
        ...
        grid.AddRow("[bold]Due Date:[/]", issue.DueDate.HasValue ? _timeHelper.FormatTime(issue.DueDate.Value, _timeFormat) : "Not set");
