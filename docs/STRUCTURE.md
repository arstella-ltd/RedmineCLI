...
│   ├── AttachmentCommand.cs          # 添付ファイルコマンド
...
2. **Commands層**: System.CommandLineを使用したコマンド定義
   ...
   - IssueCommand: チケット管理（list、view、create、edit、comment、list-attachments、download-attachments実装済み）
   - AttachmentCommand: 添付ファイル管理（download、view）（今後実装）
